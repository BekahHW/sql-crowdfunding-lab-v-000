...
"SELECT projects.category, pledges.amount FROM pledges JOIN projects ON projects.id = pledges.project_id GROUP BY projects.category HAVING projects.category = music"
end
